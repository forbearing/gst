...
var _ types.Module[*RolePermission, *RolePermission, *RolePermission] = (*RolePermissionModule)(nil)
...
func (*RolePermissionModule) Route() string { return "authz/role-permissions" }
